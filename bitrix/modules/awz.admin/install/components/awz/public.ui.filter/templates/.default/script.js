	...
	(function () {
	  ...
	  BX.Main.Filter.prototype = {
	    ...
	    backend: function backend(action, data) {
	      ...
	      this.analyticsLabel = {};
		  if(!!window.awz_helper){
			  data['key'] = window.awz_helper.key;
		  }
	      return BX.ajax.runComponentAction('awz:public.ui.filter', action, {
	        mode: 'ajax',
	        data: data,
	    ...
	    limitAnalyticsSend: function limitAnalyticsSend() {
			return;
	      BX.ajax.runComponentAction('awz:public.ui.filter', 'limitAnalytics', {
	        mode: 'ajax',
	        data: {},
	        analyticsLabel: {
	          FILTER_ID: this.getParam('FILTER_ID'),
	...
	var Fields = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Fields, [{
	    ...
	    value: function onDateChange(event) {
	      ...
	      BX.ajax.runComponentAction('awz:public.ui.filter', 'checkDateFormat', {
	        mode: 'ajax',
	        data: data,
